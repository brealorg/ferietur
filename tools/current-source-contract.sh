...
req('const val SCHEMA_VERSION = 10' in draft, 'schema_v10_missing')
...
req('DOK25_2026_2028_RULESET_VERSION = "2026.4"' in tariff_catalog, 'tariff_package_ruleset_not_immutable')
...
req('rulesetVersion == LEGACY_DOK25_2026_2028_RULESET_VERSION' in snapshot_codec, 'legacy_v1_tariff_inference_not_version_pinned')
...
req('private const val FORMAT_VERSION = WORK_PLAN_BASIS_FORMAT_VERSION' in snapshot_codec and 'WORK_PLAN_BASIS_FORMAT_VERSION = 7' in snapshot_codec, 'snapshot_v7_write_marker_missing')
